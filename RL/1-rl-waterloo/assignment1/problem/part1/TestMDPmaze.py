...
print('policyIteration(np.zeros(mdp.nStates)): (policy,V,iterId)')
...
[policy,V,nIterations,epsilon] = mdp.modifiedPolicyIteration(np.zeros(mdp.nStates,dtype=int), \
															 ...
															 tolerance=0.01)
print('modifiedPolicyIteration(np.zeros(mdp.nStates), np.zeros(mdp.nStates)): (policy,V,iterId,tolerance)')
print(policy, V, nIterations, epsilon)
print('\n')
