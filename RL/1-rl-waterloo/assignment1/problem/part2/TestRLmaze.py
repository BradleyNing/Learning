...
# Test Q-learning
[Q, policy, deltas, rewards] = rlProblem.qLearning(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=200,nSteps=100,epsilon=0.05)
print(Q, policy)
...
for epsilon in epsilons:
    [_, _, _, rewards] = rlProblem.qLearning(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),nEpisodes=200,nSteps=100,epsilon=epsilon)
    plt.plot(rewards, label='epsilon='+str(epsilon))
    #data_r.append(rewards)
plt.legend()
plt.show()
