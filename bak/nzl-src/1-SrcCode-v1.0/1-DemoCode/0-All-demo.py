...
def data_collect():
    ...
    if form.startSubmit.data:
        ...
        url = 'http://192.168.1.193:9999/daas/SDA_admin'
    ...
    if form.getAlertSubmit.data: 
        ...
        url = 'http://192.168.1.193:9999/daas/SDA_alert'
        header = {'Content-Type': 'application/json'}
...
def itrt_demo():
    ...
    if form.validate_on_submit():
        ...
        url = 'http://192.168.1.193:9999/daas/ITRT'
        header = {'Content-Type': 'application/json'}
...
def arima_demo():
    ...
    if importRawDataForm.rawDataSubmit.data:
        ...
        url = 'http://192.168.1.193:9999/daas/SDA_ARIMA'
        header = {'Content-Type': 'application/json'}
...
def DemoIndex():
    ...
    if trainingForm.trainSubmit.data:
        ...
        labelCol = trainingForm.labelCol.data
        algorithm = trainingForm.algoSelect.data
        ...
        url = 'http://127.0.0.1:9999/daas/GPAL'
        header = {'Content-Type': 'application/json'}
        res = requests.post(url, headers=header, json=req_body)
        if (not res):
    ...
    if testForm.testSubmit.data:
        ...
        testLabelCol = testForm.labelCol.data
    ...
    if predictForm.predictSubmit.data:
        algorithm = predictForm.algoSelect.data
        req_body = {"version": "v1",
